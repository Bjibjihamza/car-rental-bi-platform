...
-- MANAGERS (global supervisor has no branch)
CREATE TABLE MANAGERS (
  ...
  CONSTRAINT FK_MANAGER_BRANCH FOREIGN KEY (BRANCH_ID)
    REFERENCES BRANCHES (BRANCH_ID)
);

-- Enforce: supervisor must have NULL branch; manager must have NOT NULL branch
ALTER TABLE MANAGERS ADD CONSTRAINT CK_MGR_SUP_BRANCH
CHECK (
  (ROLE = 'SUPERVISOR' AND BRANCH_ID IS NULL)
  OR
...
CREATE TABLE CARS (
  ...
  CONSTRAINT CK_CARS_IMAGE_URL
    CHECK (IMAGE_URL IS NULL OR REGEXP_LIKE(IMAGE_URL, '^(https?://)')), -- ✅ NEW
